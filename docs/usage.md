...
| --max_contigs           | Threshold for the number of contigs > 500bp assembled by SPAdes to get scoring points | Int   | 100                        |                                                                                                                        |
| --min_align_percent     | Thresold for minimum QUAST genome fraction percentage to get scoring points           | Float | 75                         |                                                                                                                        |
| --min_reads_warn        | Threshold for minimum number of reads that will be given a QC warning                 | Int   | 150000                     |                                                                                                                        |
| --min_n50_score         | Thresold for minimum QUAST N50 value to obtain scoring points                         | Int   | 80000                      |                                                                                                                        |
